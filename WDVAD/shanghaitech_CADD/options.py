...
parser.add_argument('--frame_label_dict', type=str, default="frame_label.pickle", 
                   help='Frame-level label file (pre-update, baseline annotations)') 
parser.add_argument('--video_label_dict', type=str, default="video_label.pickle", 
                   help='Video-level label file (pre-update, baseline annotations)') 
...
# parser.add_argument('--dataset_type', type=str, default='shanghaitech', help="shanghaitech or Campus-DVAD or others")

# parser.add_argument('--pretrained_ckpt_scene_1', default='cid_2_round_5.pkl', 
#                     help='Pretrained model checkpoint for client/scene 2') 

# parser.add_argument('--pretrained_ckpt_scene_2', default='shanghaitech_1_iter_1100.pkl', 
#                     help='Pretrained model checkpoint for client/scene 1') 

# parser.add_argument('--forget_class', type=list, default=['run'],
#                     help='Anomaly classes to be updated (single or multiple)')

# parser.add_argument('--forget_class', type=list, default=['bike', 'theft'],
#                     help='Anomaly classes to be updated (single or multiple)')

# parser.add_argument('--forget_class', type=list, default=['battery_car', 'car', 'chase', 'theft'],
#                     help='Anomaly classes to be updated (single or multiple)')

parser.add_argument('--dataset_type', type=str, default='CADD', help="shanghaitech or Campus-DVAD or others")

parser.add_argument('--t_id', type=list, default=[2],
                    help='Teacher client IDs excluded from training (e.g., [1] for client 1)')

parser.add_argument('--pretrained_ckpt_scene_1', default='cid_1_round_5.pkl', 
                    help='Pretrained model checkpoint for client/scene 2') 

parser.add_argument('--pretrained_ckpt_scene_2', default='CADD_2_iter_2000.pkl', 
                    help='Pretrained model checkpoint for client/scene 1') 

# parser.add_argument('--forget_class', type=list, default=['bike'],
#                     help='Anomaly classes to be updated (single or multiple)')

# parser.add_argument('--forget_class', type=list, default=['run', 'skateboard', 'throw', 'tricycle'],
#                     help='Anomaly classes to be updated (single or multiple)')

parser.add_argument('--forget_class', type=list, default=['bike', 'basketball', 'car', 'run', 'throw', 'football'],
                    help='Anomaly classes to be updated (single or multiple)')
