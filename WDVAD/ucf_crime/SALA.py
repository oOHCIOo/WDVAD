...
class SALA:
    ...
    def adaptive_local_aggregation(self, 
        ...
        subset_train_dataset = Subset(train_data, indices)
        ...
        while True:
            for i, data in enumerate(rand_loader):
                ...
                element_logits = model_t(features)
                ...
                if it % 20 == 0 and it != 0:
                    print(f'Iteration: {it}, SALA_Loss: {total_loss.data.cpu().detach().numpy()}')
                    losses_weight.append(total_loss.item())     # A LOSS VALUE IS ADDED EVERY 20 ITERATIONS
